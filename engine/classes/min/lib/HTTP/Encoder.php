...
class HTTP_Encoder {
    ...
    public static function getAcceptedEncoding($allowCompress = true, $allowDeflate = true)
    {
        ...
        if (headers_sent() || connection_aborted() || ini_get('zlib.output_compression')) {
            return array('', '');
        }

        if (strpos($_SERVER['HTTP_ACCEPT_ENCODING'], 'br' ) !== false AND function_exists( 'brotli_compress' ) ) return array('br', 'br');
        if (strpos($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip') !== false AND function_exists( 'gzencode' ) ) return array('gzip', 'gzip');
